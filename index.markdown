  ...
  <div class="container hero-grid">
    <div>
      ...
      <div class="hero-metrics">
        <div>
          <div class="metric">30 min</div>
          <div class="muted">weekly time saved</div>
        </div>
        <div>
          <div class="metric">100%</div>
          <div class="muted">audit-ready records</div>
        </div>
        <div>
          <div class="metric">1 place</div>
          <div class="muted">for every team dollar</div>
        </div>
      </div>
    </div>
    <div class="hero-card">
...
<section class="section" id="problems">
  <div class="container">
    ...
    <div class="grid four">
      <div class="info-card">
        <h3>Scattered spreadsheets</h3>
        <p>Centralize budgets, transactions, and receipts in one reliable view.</p>
      </div>
      <div class="info-card">
...
<section class="section" id="features">
  <div class="container">
    <div class="section-heading">
      <h2>Features that feel like extra hands.</h2>
      <p class="muted">Lead with outcomes, then trust the tools to keep you on track.</p>
    </div>
...
<section class="section alt" id="how">
  <div class="container">
    <div class="section-heading">
      <h2>How it works</h2>
      <p class="muted">Three steps from setup to season-long financial confidence.</p>
    </div>
    <div class="steps">
      <div class="step">
...
<section class="section alt" id="proof">
  <div class="container">
    <div class="section-heading">
      <h2>Trusted by treasurers who value their time.</h2>
      <p class="muted">Social proof section ready for real stories as they arrive.</p>
    </div>
    <div class="grid two">
...
<section class="section" id="pricing">
  <div class="container">
    <div class="section-heading">
      <h2>Simple, volunteer-friendly pricing.</h2>
      <p class="muted">Transparent tiers with no hidden fees. Pick the plan that matches your season.</p>
    </div>
    <div class="pricing-grid">
      <div class="pricing-card">
        <div class="pricing-title">Starter Team</div>
        <div class="pricing-price">$0</div>
        <div class="pricing-period">for pilot teams</div>
        <ul>
          <li>1 team, 1 season</li>
...
<section class="section alt" id="faq">
  <div class="container">
    <div class="section-heading">
      ...
      <p class="muted">Quick answers to common treasurer concerns.</p>
    </div>
    <div class="faq-grid">
      <div class="faq-item">
        <h3>Can I import existing data?</h3>
        <p>Yes. CSV imports handle rosters, transactions, and past budgets.</p>
      </div>
      <div class="faq-item">
...
<section class="section alt" id="about">
  <div class="container about">
    ...
    <div class="about-card">
      ...
      <p>Give every volunteer treasurer a clear, confident financial process.</p>
